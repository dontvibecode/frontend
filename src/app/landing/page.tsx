...
function BoxInView() {
  ...
  return (
    <motion.div 
      ref={boxRef} 
      initial={{ scale: 0.9, y: yOffset, borderRadius: "0.5rem" }} 
      animate={{ 
        scale: isInView ? 1 : 0.9, 
        y: isInView ? 0 : yOffsetOut, 
        borderRadius: isInView ? "4rem" : "0.5rem" 
      }} 
...
export default function LandingPage() {
  ...
  return (
    <div ref={containerRef} className="relative min-h-[300vh] overflow-x-hidden bg-white pt-14">
          ...
          >
              ...
              <div className="flex items-center gap-3">
                ...
                <Link href="/chat" className="cursor-pointer ml-auto w-10 h-10 rounded-full bg-black flex items-center justify-center hover:bg-gray-800 transition-all -rotate-45">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" stroke-width="2" d="m5 12l-.604-5.437C4.223 5.007 5.825 3.864 7.24 4.535l11.944 5.658c1.525.722 1.525 2.892 0 3.614L7.24 19.466c-1.415.67-3.017-.472-2.844-2.028zm0 0h7"/></svg>
                </Link>
              </div>
              </div>
          </motion.div>
      ...
      <section className="mx-4 my-10 min-h-[100vh] flex flex-col items-center justify-center gap-20">
        <svg
        ...
        <div className="relative bg-white border border-gray-200 w-full rounded-3xl overflow-hidden my-14 shadow-[0_0_70px_0_rgba(0,0,0,0.08)] max-w-2xl">
